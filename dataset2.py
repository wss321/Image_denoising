...
def load_test_data_3C(shuffle_buffer_size=10000):
...
def load_train_data_3C(shuffle_buffer_size=10000):
...
def visualize_image(image, visual=True, title=''):
    ...
    # # img = image_to_visualize.reshape(256, 256, 3)
    if visual:
        plt.figure()
        plt.title(title)
        if num_dims == 2:
